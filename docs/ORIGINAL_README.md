...
![演示视频缩略图](./assets/images/ytb.png)

### 多智能体RAG系统流程图
![系统运行流程图](./assets/graphs/multi-agent-rag-system-graph.png)
...
![LangSmith](./assets/images/langsmith.gif)
...
1.  **旅行数据库**:
    ...
    ![数据库结构](./assets/images/travel_db_schema.png)
...
2.  **Qdrant**:
    ...
    ![Qdrant 结构](./assets/images/qdrant_schema.png)
...
*   [graphs](./assets/graphs/README.md)
