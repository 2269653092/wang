...
4. If successful, run the vectorizer: `poetry run python vectorizer/main.py`
...
- `vectorizer/core/settings.py` - Added embedding API settings
- `vectorizer/vectordb/vectordb.py` - Uses embedding API configuration
- `vectorizer/embeddings/embedding_generator.py` - Uses embedding API configuration